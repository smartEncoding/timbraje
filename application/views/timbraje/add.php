    ...
    <div class="col-md-12">
      	<div class="box box-info">
            <div class="box-header with-border">
              	<h3 class="box-title">Timbraje Add</h3>
            </div>
            <?php echo form_open('timbraje/add'); ?>
          	<div class="box-body">
          		<div class="row clearfix">
					...
					<div class="col-md-6">
						...
						<div class="form-group">
							<select name="id_cliente" class="form-control">
								...
								{
									$selected = ($empresa['id'] == $this->input->post('id_cliente')) ? ' selected="selected"' : "";
					...
					<div class="col-md-6">
						...
						<div class="form-group">
							<input type="text" name="id_comprobante" value="<?php echo $this->input->post('id_comprobante'); ?>" class="form-control" id="id_comprobante" />
						</div>
					</div>
				</div>
			</div>
